<?php echo form_open('cliente/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_cod" value="<?php echo $this->input->post('clientes_cod'); ?>" class="form-control" id="clientes_cod" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_tipo" value="<?php echo $this->input->post('clientes_tipo'); ?>" class="form-control" id="clientes_tipo" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_rg_orgao" value="<?php echo $this->input->post('clientes_rg_orgao'); ?>" class="form-control" id="clientes_rg_orgao" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_rg_uf" value="<?php echo $this->input->post('clientes_rg_uf'); ?>" class="form-control" id="clientes_rg_uf" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_rg_expedicao" value="<?php echo $this->input->post('clientes_rg_expedicao'); ?>" class="form-control" id="clientes_rg_expedicao" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_cnh" value="<?php echo $this->input->post('clientes_cnh'); ?>" class="form-control" id="clientes_cnh" />
			<?php echo form_error('clientes_cnh'); ?>
		</div>
	</div>
	<div class="form-group">
		<label for="clientes_cod_despachente" class="col-md-4 control-label">Código Despachante</label>
		<div class="col-md-8">
			<input type="text" name="clientes_cod_despachente" value="<?php echo $this->input->post('clientes_cod_despachente'); ?>" class="form-control" id="clientes_cod_despachente" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_despachante" value="<?php echo $this->input->post('clientes_despachante'); ?>" class="form-control" id="clientes_despachante" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_cod_municipio" value="<?php echo $this->input->post('clientes_cod_municipio'); ?>" class="form-control" id="clientes_cod_municipio" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_municipio" value="<?php echo $this->input->post('clientes_municipio'); ?>" class="form-control" id="clientes_municipio" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_uf" value="<?php echo $this->input->post('clientes_uf'); ?>" class="form-control" id="clientes_uf" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_endereco" value="<?php echo $this->input->post('clientes_endereco'); ?>" class="form-control" id="clientes_endereco" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_cep" value="<?php echo $this->input->post('clientes_cep'); ?>" class="form-control" id="clientes_cep" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_tipo_endereco" value="<?php echo $this->input->post('clientes_tipo_endereco'); ?>" class="form-control" id="clientes_tipo_endereco" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_telefone_residencial" value="<?php echo $this->input->post('clientes_telefone_residencial'); ?>" class="form-control" id="clientes_telefone_residencial" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_cod_municipio" value="<?php echo $this->input->post('clientes_corres_cod_municipio'); ?>" class="form-control" id="clientes_corres_cod_municipio" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_municipio" value="<?php echo $this->input->post('clientes_corres_municipio'); ?>" class="form-control" id="clientes_corres_municipio" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_uf" value="<?php echo $this->input->post('clientes_corres_uf'); ?>" class="form-control" id="clientes_corres_uf" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_endereco" value="<?php echo $this->input->post('clientes_corres_endereco'); ?>" class="form-control" id="clientes_corres_endereco" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_bairro" value="<?php echo $this->input->post('clientes_corres_bairro'); ?>" class="form-control" id="clientes_corres_bairro" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_complemento" value="<?php echo $this->input->post('clientes_corres_complemento'); ?>" class="form-control" id="clientes_corres_complemento" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_numero" value="<?php echo $this->input->post('clientes_corres_numero'); ?>" class="form-control" id="clientes_corres_numero" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_cep" value="<?php echo $this->input->post('clientes_corres_cep'); ?>" class="form-control" id="clientes_corres_cep" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_tipo_endereco" value="<?php echo $this->input->post('clientes_corres_tipo_endereco'); ?>" class="form-control" id="clientes_corres_tipo_endereco" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_corres_nome_tipo_endereco" value="<?php echo $this->input->post('clientes_corres_nome_tipo_endereco'); ?>" class="form-control" id="clientes_corres_nome_tipo_endereco" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_data_nascimento" value="<?php echo $this->input->post('clientes_adicionais_data_nascimento'); ?>" class="form-control" id="clientes_adicionais_data_nascimento" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_mae" value="<?php echo $this->input->post('clientes_adicionais_mae'); ?>" class="form-control" id="clientes_adicionais_mae" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_pai" value="<?php echo $this->input->post('clientes_adicionais_pai'); ?>" class="form-control" id="clientes_adicionais_pai" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_estado_civil" value="<?php echo $this->input->post('clientes_adicionais_estado_civil'); ?>" class="form-control" id="clientes_adicionais_estado_civil" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_nascionalidade" value="<?php echo $this->input->post('clientes_adicionais_nascionalidade'); ?>" class="form-control" id="clientes_adicionais_nascionalidade" />
			<?php echo form_error('clientes_adicionais_nascionalidade'); ?>
		</div>
	</div>
	<div class="form-group">
		<label for="clientes_adicionais_cod_municipio_natural" class="col-md-4 control-label">Código Município Natural</label>
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_cod_municipio_natural" value="<?php echo $this->input->post('clientes_adicionais_cod_municipio_natural'); ?>" class="form-control" id="clientes_adicionais_cod_municipio_natural" />
			<?php echo form_error('clientes_adicionais_cod_municipio_natural'); ?>
		</div>
	</div>
	<div class="form-group">
		<label for="clientes_adicionais_nome_municipio_naturalidade" class="col-md-4 control-label">Nome Municipio Naturalidade</label>
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_nome_municipio_naturalidade" value="<?php echo $this->input->post('clientes_adicionais_nome_municipio_naturalidade'); ?>" class="form-control" id="clientes_adicionais_nome_municipio_naturalidade" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_uf" value="<?php echo $this->input->post('clientes_adicionais_uf'); ?>" class="form-control" id="clientes_adicionais_uf" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_cep" value="<?php echo $this->input->post('clientes_adicionais_cep'); ?>" class="form-control" id="clientes_adicionais_cep" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_sexo" value="<?php echo $this->input->post('clientes_adicionais_sexo'); ?>" class="form-control" id="clientes_adicionais_sexo" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_cod_profissao" value="<?php echo $this->input->post('clientes_adicionais_cod_profissao'); ?>" class="form-control" id="clientes_adicionais_cod_profissao" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="clientes_adicionais_profissao" value="<?php echo $this->input->post('clientes_adicionais_profissao'); ?>" class="form-control" id="clientes_adicionais_profissao" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="clientes_adicionais_obs_resumida" class="form-control" id="clientes_adicionais_obs_resumida"><?php echo $this->input->post('clientes_adicionais_obs_resumida'); ?></textarea>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="clientes_observacao_livre" class="form-control" id="clientes_observacao_livre"><?php echo $this->input->post('clientes_observacao_livre'); ?></textarea>
