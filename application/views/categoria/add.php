<?php echo form_open('categoria/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="categorias_cod" value="<?php echo $this->input->post('categorias_cod'); ?>" class="form-control" id="categorias_cod" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<textarea name="categorias_nome" class="form-control" id="categorias_nome"><?php echo $this->input->post('categorias_nome'); ?></textarea>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="categorias_abre" value="<?php echo $this->input->post('categorias_abre'); ?>" class="form-control" id="categorias_abre" />
